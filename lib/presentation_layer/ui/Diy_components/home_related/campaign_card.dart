...
Widget CampaignCard(double mdw,double mdh,String picurl,String foodname,String restaurant,String price,String discount,String rating) {
  {
    return Container(
                      ...
                      children: [
                        ...
                        Visibility(
                          ...
                          child: Text("\$${int.parse(price)+int.parse(discount)}", style: TextStyle(
                              color: Color(0xFFafafae), fontSize: mdw * 0.028,decoration: TextDecoration.lineThrough),),
                        ),
                      ],
                    ),
